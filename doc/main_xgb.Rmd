...
```{r wkdir, eval=FALSE}
set.seed(2018)
setwd("/Users/apple/Documents/GitHub/Proj3/Spring2019-Proj3-spring2019-proj3-grp7/doc/") 
...
```{r}
train_dir <- "/Users/apple/Documents/GitHub/Proj3/Spring2019-Proj3-spring2019-proj3-grp7/data/train_set/" # This will be modified for different data sets.
...
```{r feature}
source("/Users/apple/Documents/GitHub/Proj3/Spring2019-Proj3-spring2019-proj3-grp7/lib/feature.R")
...
save(dat_train, file="/Users/apple/Documents/GitHub/Proj3/Spring2019-Proj3-spring2019-proj3-grp7/output/feature_train.RData")
```
...
```{r loadlib}
source("/Users/apple/Documents/GitHub/Proj3/Spring2019-Proj3-spring2019-proj3-grp7/lib/train_xgb.R")
source("/Users/apple/Documents/GitHub/Proj3/Spring2019-Proj3-spring2019-proj3-grp7/lib/test_xgb.R")
```
...
source("/Users/apple/Documents/GitHub/Proj3/Spring2019-Proj3-spring2019-proj3-grp7/lib/cross_validation.R")
...
if(run.cv){
  ...
  save(err_cv, file="/Users/apple/Documents/GitHub/Proj3/Spring2019-Proj3-spring2019-proj3-grp7/output/err_cv.RData")
}
```
...
```{r cv_vis}
if(run.cv){
  load("/Users/apple/Documents/GitHub/Proj3/Spring2019-Proj3-spring2019-proj3-grp7/output/err_cv.RData")
...
save(fit_train, file="/Users/apple/Documents/GitHub/Proj3/Spring2019-Proj3-spring2019-proj3-grp7/output/fit_train.RData")
```
...
```{r superresolution}
source("/Users/apple/Documents/GitHub/Proj3/Spring2019-Proj3-spring2019-proj3-grp7/lib/superResolution.R")
test_dir <- "/Users/apple/Documents/GitHub/Proj3/Spring2019-Proj3-spring2019-proj3-grp7/data/test_set/" # This will be modified for different data sets.
test_LR_dir <- paste(test_dir, "LR/", sep="")
test_HR_dir <- paste(test_dir, "HR/", sep="")

tm_test=NA
if(run.test){
  load(file="/Users/apple/Documents/GitHub/Proj3/Spring2019-Proj3-spring2019-proj3-grp7/output/fit_train.RData")
  tm_test <- system.time(superResolution_xgboost(test_LR_dir, test_HR_dir, fit_train))
  PSNR <- superResolution_xgboost(test_LR_dir, test_HR_dir, fit_train)
}
